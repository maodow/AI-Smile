...
import com.example.ai_smile.utils.CheckUtil;

public class LoginRegRequestValue implements UseCase.RequestValues {
...
//        if (!CheckUtil.getInstance().phoneNumCheck(account)) {
