...
import com.example.ai_smile.activity.CameraImageFormat;
import com.example.ai_smile.activity.CameraRotation;
import java.io.File;
    ...
    public static boolean saveImageFromFile(@NonNull Bitmap bitmap,
        ...
        try {
            if (!fileToSave.exists()) {
                if (!fileToSave.getParentFile().exists()) {//自定义imagePath为多层目录下的文件，要先创建层级目录
