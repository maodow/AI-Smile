...
public class CameraShutterBtn extends View {
    ...
    public CameraShutterBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray t = getContext().obtainStyledAttributes(attrs, R.styleable.CameraShutterBtn);
        duration = t.getInt(R.styleable.CameraShutterBtn_duration, 15);
        outcirclecolor = t.getColor(R.styleable.CameraShutterBtn_backgroudcolor, outcirclecolor);
        innercirclecolor = t.getColor(R.styleable.CameraShutterBtn_innercirclecolor, innercirclecolor);
        progresscolor = t.getColor(R.styleable.CameraShutterBtn_progresscolor, progresscolor);
        progresswidth = t.getDimensionPixelOffset(R.styleable.CameraShutterBtn_progresswidth, progresswidth);
        marign = (int) t.getDimension(R.styleable.ConstraintSet_android_layout_marginLeft, 0);
        t.recycle();
    }

    public CameraShutterBtn(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        innercirclecolor = t.getColor(R.styleable.CameraShutterBtn_innercirclecolor, innercirclecolor);
        progresscolor = t.getColor(R.styleable.CameraShutterBtn_progresscolor, progresscolor);
        progresswidth = t.getInt(R.styleable.CameraShutterBtn_progresswidth, progresswidth);
        t.recycle();
    }
