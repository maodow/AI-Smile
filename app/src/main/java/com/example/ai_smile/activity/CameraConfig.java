...
public final class CameraConfig {
    ...
    String getPhotoName() {
        return System.currentTimeMillis() + (mImageFormat == CameraImageFormat.FORMAT_JPEG ? ".jpeg" : ".png");
    }


    String getmPhotoSavePath() {
    ...
    public class Builder {
        ...
        public Builder setPhotoSavePath(String path) {
            mPhotoSavePath = path;
            return this;
        }
        ...
        private File getDefaultStorageFile() {
            return new File(CameraUtils.getCacheDir(mContext).getAbsolutePath()
                    + File.separator
